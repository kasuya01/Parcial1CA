...
echo '<!-- Start Required XML Menu markup for head tag -->
	...
	<table width="100%" border="0" bgcolor="#FFFFFF">
		...
		<td style="vertical-align:top">
                    <h2 align="center" >Ministerio de Salud <br> Sistema de Informaci&oacute&oacute;n de Atenci&oacute;n de Pacientes<br><br>' . htmlentities($Establecimiento) . ' <br><br>
			...
			<div id="id_xm"></div>
			<script type="text/javascript">new XmlMenu("id_xm", "../../../Menu/xm-data31.xml")</script>
