        ...
        <script language="JavaScript" >
            ...
            function list_reload(obj,acn){
               ...
               if (acn==1){
                 ...
                 // nombre_reporta=$('#nombrereporta').val();
                  if (codreporte==0 ){
                              alert ('Ingrese el resultado de tabulador por favor');
                              return false
                           }         
                  }
...
//                    obj_lista.appendChild(option);//insertamos el elemento                                     
                ...
                document.getElementById('resultado').value = txt_id;
                document.getElementById('resultado_nombre').value = txt_text;
                document.getElementById('id_resultado').value = id_text;
                $("#myModal").modal("hide");
...
function abrirmodal(){
   ...
   //$("#nombrereporta").val(objtext);
    ...
    <body>
         ...
         */
        $aposresultados = explode(',',$resultado);
        $aposresultados_text = explode(',',$resultado_nombre); 
        $aposresultados_id = explode(',',$id_resultado); 
        
//         $aposresultados = explode(',',$metodologias_sel);
//        $aposresultados_text = explode(',',$text_metodologias_sel); 
//        $aposresultados_id = explode(',',$id_metodologias_sel); 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Opciones Posible Resultado</h4>
      </div>
      <div class="modal-body">
         <form>
<!--          <div class="form-group">
            <label for="metodologia-name" class="control-label">Nombre con el que reportara:</label>
            <input type="text" class="form-control" id="nombrereporta">
          </div>-->
          <div class="form-group">
            <label for="tabulador-id" class="control-label">Seleccione el tipo de resultado en tabulador:</label>
             <select id="cmbcodigoresultado" name="codigoresultado" class="form-control height" style="width: 40%">
                 <option value="0">Seleccione una opción</option>
                 <?php
                 $d= $obj->buscarcodigores();
...
<!--         <center>
            <label>Nombre con el que reportara</label>
            <input id="nombrereporta" name="nombrereporta" type="text"/>
              <label>Seleccione el tipo de resultado en tabulador</label>
              <select id="cmbcodigoresultado" name="codigoresultado" class="form-control height" style="width: 40%">
                 <option value="0">Seleccione una opción</option>
                 <?php
...
//                 }
    ...
    <script language="JavaScript">
        function cerrar(){
            opener.document.<?php print $form; ?>.resultado.value=document.getElementById('resultado').value;
            opener.document.<?php print $form; ?>.resultado_nombre.value=document.getElementById('resultado_nombre').value;
            opener.document.<?php print $form; ?>.id_resultado.value=document.getElementById('id_resultado').value;
            window.close();
        }
    </script>    
