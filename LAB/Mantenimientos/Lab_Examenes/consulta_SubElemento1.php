...
FormSubmit(); */
    ...
    <body>
        <form method="post">
            ...
            if(isset($btnGuardar)){
                 ...
                 */
                $obj->cambiar_estadolab_exaposible_resultado($idconf);
                ...
                for ($i=0;$i<count($elementos)-1;$i++){
                    ...
                    $obj->cambiar_estado_idlab_posibleresultado($elementos[$i],$idconf);
                }
                //echo "<script>window.close();</script>";
                /* 
                 *MOSTRAR UN ALERT  RESGUISTROS GUARDADOS CORRECTAMENTE
                 */
            }
    ...
    //        }
          ...
          <input type="hidden" name="id_subelemento" id="id_subelemento" value="<?php print $idconf; ?>">
        </form>
    </body>
</html>
