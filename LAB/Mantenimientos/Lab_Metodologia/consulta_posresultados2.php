...
jQuery(document).ready(function($) {
   ...
   $('.ms-selectable li[data-target="#myModal"]').on('click', function(){
    console.log($(this).attr('id'));
    $('#myModal').modal('toggle');
    
});
  
   $('.ms-selection li[data-target="#myModal"]').on('click', function(){
    console.log($(this).attr('id'));
    $('#myModal').modal('toggle');
      ...
      echo '<strong><font color="white"> 
       ...
       // $table .= "<tr><head><center><label id='nombre_prueba'>".$nombre_prueba."</label></center></head></tr>";
        ...
        $table .= "<td>";
         ...
         $table .="<select name='lista' id='lista' size=22 style='width: 100%;height:400px;' class='searchable'  multiple='multiple'  data-live-search='true'>";
