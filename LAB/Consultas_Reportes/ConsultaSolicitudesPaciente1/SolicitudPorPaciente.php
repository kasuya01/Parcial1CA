...
<tr>
	<td>
		...
		<form>
			...
			Consulta de Solicitudes por Paciente</strong></h3></td>
			</tr>
			<tr>		
				<td class="StormyWeatherFieldCaptionTD">Tipo Establecimiento</td>
				<td class="StormyWeatherDataTD"><select name="cmbTipoEstab" id="cmbTipoEstab" style="width:375px" onChange="BuscarEstablecimiento(this.value)">
