...
{
	if ((document.getElementById('cmbArea').value == 0) && (document.getElementById('txtexpediente').value == "")&& (document.getElementById('txtfecharecep').value == "")&& (document.getElementById('CmbServicio').value == 0)&& (document.getElementById('cmbEstablecimiento').value == 0) && (document.getElementById('cmbSubServ').value == 0) && (document.getElementById('cmbExamen').value == 0) && (document.getElementById('PrimerNombre').value == "") && (document.getElementById('SegundoNombre').value == "")&& (document.getElementById('PrimerApellido').value == "")&& (document.getElementById('SegundoApellido').value == "")){
...
<tr>
	<td class="StormyWeatherFieldCaptionTD" style="font-weight:bold"  width="28%">
		<b>&Aacute;rea de Laboratorio </b>
	</td>
    	<td class="StormyWeatherDataTD"  width="19%">
  ...
  <tr>
	...
	<td  class="StormyWeatherDataTD" width="4%"><input type="text" size="24" name="txtexpediente" id="txtexpediente" />
	</td>
	<td class="StormyWeatherFieldCaptionTD" width="20%" >Fecha Recepi&oacute;n</td>
	<td  class="StormyWeatherDataTD">
