...
<html>
<head>
<title>Historial de Estudios de Imagenología - Consulta Externa</title>
<link rel="stylesheet" type="text/css" href="../Themes/Salad/Style.css">
<link rel="stylesheet" type="text/css" href="./Estilo.css">
<script language="javascript" src="ajax.js"></script>
</head>
<body link="#000099" alink="#ff0000" vlink="#000099" text="#000000" bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" marginwidth="0" marginheight="0" bgcolor="#ffffff">
  <center><a align="center"><img src='./Themes/Rayosx.jpg'></a></center>
<!-- Recuperar los Datos del Paciente -->
			
<?php echo "<form><table width='100%' align='center' border='0'>	
			<tr>
				<td width='45%'><h2>No Expediente: ".$IdNumeroExp."	<br>
								Nombre: ".$Nombre."	</h2></td>
...
?>
   ...
   <div id="ConsultasRX">
    <?php 
		$Imagenologia->SolicitudesImagenologia($Conectar,$IdNumeroExp,5);
	 ?>
   </div>
<div id="DetalleSolicitudesRx">
