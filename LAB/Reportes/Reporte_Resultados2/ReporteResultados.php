			...
			<select name="CmbServicio" id="CmbServicio" style="width:405px" onChange="BuscarServicio(this.value)" class="height placeholder js-example-basic-single" >
				...
				<option value="0" selected="selected"> Seleccione un Servicio </option>
                 ...
                 <tr>
                            ...
                            <td class="StormyWeatherDataTD">
                                <select id="cmbArea" name="cmbArea"  size="1" onChange="BuscarExamen(this.value)" style="width:443px" class="js-example-basic-multiple height" multiple="multiple">
                            ...
                            <td  class="StormyWeatherDataTD" >
                                <div id="divExamen">
                                    <select name="cmbExamen" id="cmbExamen" class="height  js-example-basic-multiple" style="width:500px" multiple="multiple" >
