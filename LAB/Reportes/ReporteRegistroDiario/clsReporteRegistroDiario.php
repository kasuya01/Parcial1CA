...
WITH tbl_servicio AS ( SELECT t02.id, 
               ...
               (CASE WHEN id_servicio_externo_estab IS NOT NULL THEN t05.abreviatura ||'-->'  || t06.nombre
                ...
                WHERE t16.idestado != 'RM' AND t02.id_establecimiento = $lugar AND t02.id_establecimiento_externo = $lugar AND t08.id = $idarea AND t03.fecharecepcion = '$d_fechadesde'
                ...
                WHERE t16.idestado != 'RM' AND t02.id_establecimiento = $lugar AND t02.id_establecimiento_externo = $lugar AND t08.id = $idarea AND t03.fecharecepcion = '$d_fechadesde' ) ordenar
