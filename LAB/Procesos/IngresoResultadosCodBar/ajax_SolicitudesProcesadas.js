...
function ImprimirPlantillaA(idsolicitud,idexamen,resultado,lectura,interpretacion,observacion,responsable){

 ventana_secundaria = window.open("ImprimirPlantillaA.php?var1="+idsolicitud+
			 "&var2="+idexamen+"&var3="+
			 "&var3="+encodeURIComponent(resultado)+"&var4="+encodeURIComponent(lectura)+
			 "&var5="+encodeURIComponent(interpretacion)+"&var6="+encodeURIComponent(observacion)+
			 "&var7="+responsable,"ImprimirA","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert (establecimiento);
 ventana_secundaria = window.open("ImprimirPlantillaA1.php?var1="+idsolicitud+
				...
				"&var6="+encodeURIComponent(valores_lecturas)+"&var7="+encodeURIComponent(valores_inter)+
				"&var8="+encodeURIComponent(valores_obser)+"&var9="+codigos_examenes+"&var10="+escape(establecimiento)+
...
function ImprimirPlantillaB(idsolicitud,idexamen,responsable,procedencia,origen,observacion,valores_subelementos,codigos_subelementos,valores_elementos,codigos_elementos,controles,controles_ele,nombrearea,establecimiento,responsable,sexo,idedad){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaB.php?var1="+idsolicitud+
			...
			"&var12="+controles_ele+
			"&var13="+escape(nombrearea)+"&var14="+escape(establecimiento)+"&var15="+responsable+
...
function ImprimirPlantillaC(idsolicitud,idexamen,resultado,responsable,procedencia,origen,observacion,valores_antibioticos,codigos_antibioticos,idbacteria,cantidad,idtarjeta,nombrearea,estab){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaC.php?var1="+idsolicitud+
			...
			"&var4="+escape(responsable)+"&var5="+procedencia+
...
function ImprimirPlantillaCN(idsolicitud,idexamen,idarea,resultado,responsable,procedencia,origen,observacion){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaCN.php?var1="+idsolicitud+
	...
	"&var4="+encodeURIComponent(resultado)+"&var5="+responsable+"&var6="+escape(procedencia)+
	"&var7="+escape(origen)+"&var8="+encodeURIComponent(observacion)+"&var9="+escape(estab),"ImprimirCN","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert (idarea);
 ventana_secundaria = window.open("ImprimirPlantillaE.php?var1="+idsolicitud+
		...
		"&var10="+escape(estab),"ImprimirE","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
  ...
  if (ValidarCamposPlantillaC())
  	{
		...
		//nombrearea="";
		  ...
		  //muy importante este encabezado ya que hacemos uso de un formulario
			...
			"&idrecepcion="+idrecepcion+"&iddetalle="+iddetalle+"&observacion="+encodeURIComponent(observacion)+
...
function MostrarResultadoExamen(idsolicitud,iddetalle,idarea,idexamen,resultado,lectura,interpretacion,observacion,responsable,nombrearea,procedencia,origen,impresion,establecimiento,codigo,fechanac,sexo)
{
 ...
 //alert (codresult);
	ajax.send("opcion="+opcion+"&idarea="+area+
		  ...
		  "&observacion="+encodeURIComponent(observacion)+"&responsable="+escape(responsable)+"&nombrearea="+escape(nombrearea)+
  ...
  if (ValidarCamposPlantillaB())
  {
	...
	//{
		...
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
		  ...
		  "&valores_elementos="+escape(valores_elementos)+"&codigos_elementos="+codigos_elementos+"&controles="+escape(controles)+
		  "&controles_ele="+escape(controles_ele)+"&estab="+escape(estab)+"&tab="+tab+"&fechanac="+fechanac+"&sexo="+sexo);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{	 if (ajax.status == 200)
...
function CargarExamenes(idsolicitud,idarea,fechanac,sexo)
{
   	ajax=objetoAjax();
        FechaNac=fechanac;
        Sexo=sexo;
...
function MostrarDatos(posicion)
{
		...
		{ 	case "A":
				if (idarea=="QUI"){
					...
					"&var7="+paciente+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+procedencia+"&var11="+origen+
					"&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
				}
				else{
		  	...
		  	case "B":
				...
				"&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no");
		  	break;
		  	case "C":
				...
				"&var7="+escape(paciente)+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+procedencia+"&var11="+origen+
				"&var12="+impresion+"&var13="+estab,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  	break;
		  	case "D":
				ventana_dos = window.open("ProcDatosResultadosExamen_PD.php?var1="+idexpediente+
				"&var2="+examen+"&var3="+idexamen+"&var4="+idarea+"&var5="+detallesolicitud+"&var6="+idsolicitud+
				"&var7="+escape(paciente)+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+procedencia+"&var11="+origen+
				"&var12="+impresion+"&var13="+estab,"Resultados","width=950,height=700,menubar=no,scrollbars=yes") ;
		  	break;
		 	case "E":
		 		ventana_dos = window.open("ProcDatosResultadosExamen_PE.php?var1="+idexpediente+
				"&var2="+examen+"&var3="+idexamen+"&var4="+idarea+"&var5="+detallesolicitud+"&var6="+idsolicitud+
				"&var7="+escape(paciente)+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+procedencia+"&var11="+origen+
				"&var12="+impresion+"&var13="+estab,"Resultados","width=950,height=950,menubar=no,scrollbars=yes") ;
		break;
		}
...
function SolicitudesPorArea()
{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	 //enviando los valores
	ajax.send("opcion="+opcion+"&idarea="+idarea+"&idexpediente="+idexpediente+"&idexamen="+idexamen+"&IdEstab="+IdEstab+"&IdServ="+IdServ+
	"&IdSubServ="+IdSubServ+"&PNombre="+PNombre+"&SNombre="+SNombre+"&PApellido="+PApellido+"&SApellido="+SApellido+"&fechasolicitud="+fechasolicitud+
	"&Codigo="+Codigo+"&Orden="+Orden+"&TipoSolic="+TipoSolic);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
...
function GuardarPlantillaD()
{
	...
	else{alert("Complete la Informacion requerida");}
}
...
function CargarProcesosExamen(codigoex)
{
	...
	ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&observacion="+escape(observacion));
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	if (ajax.status == 200)
