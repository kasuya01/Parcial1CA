...
include_once("clsSolicitudesProcesadas.php");
  ...
  $consulta=$objdatos->DetalleExamenes($idsolicitud,$idarea,$lugar,$sexo,$idedad);
...
?>
	<table width='85%' align='center' class='StormyWeatherFormTABLE'>
		...
		<tr>
			...
			<td colspan='1' style='font:bold'><?php echo $row_fecha['FechaResultado']?></td>
		</tr>
		</tr>	
	...
	<table width='85%'  align='center' border='0' class='StormyWeatherFormTABLE'>
		...
		?>     	<td><?php echo htmlentities($vector_resultados[$pos])?></td>
