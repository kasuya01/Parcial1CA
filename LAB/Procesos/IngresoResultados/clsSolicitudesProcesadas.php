...
and t01.idestablecimiento=$lugar;";
   ...
   //Fn Pg
   function buscarexamresult($iddetalle, $idsolicitud, $lugar, $idexamen, $sexo,
           $idedad) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
...
and b_reporta=true order by nombre_metodologia";
   ...
   //FUNCION PARA MOSTRAR LOS DATOS GENERALES DE LA SOLICITUD PROCESADA
   function MostrarDatosPersona($idsolicitud, $lugar,
           $id_establecimiento_externo, $nec, $idhistoref) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
...
//Funcion utilizada para conocer cuantas metodologias tiene un examen
   ...
   function InsertarResultadoPlantillaA($idexamen, $idsolicitud, $iddetalle,
           $resultado, $lectura, $observacion, $responsable, $lectura,
           $idrecepcion, $interpretacion, $observacion, $usuario, $codigo,
           $lugar) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
...
//Fn Pg
   ...
   //FUNCION PARA GUARDAR RESULTADOS
   function InsertarResultadoPlantillaAM($hdnidexamen_, $hdnIdMetodologia_,
           $hdnResp_, $hdnFecProc_, $hdnFecResu_, $hdnResult_, $hdnObserva_,
           $hdnCodResult_, $idsolicitud, $usuario, $iddetalle, $idrecepcion,
           $lugar, $idresultado, $marca, $lectura) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
   ...
   //FUNCION PARA GUARDAR RESULTADOS
   function InsertarResultadoPlantillaAF($idsolicitud, $iddetalle, $idrecepcion,
           $v_resultfin, $v_lectura, $v_interpretacion, $v_obserrecep, $lugar,
           $usuario, $idexamen, $cmbEmpleadosfin, $d_resultfin, $idresultado,
           $marca) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
   ...
   function InsertarResultadoPlantillaA1($idexamen, $idsolicitud, $iddetalle,
           $resultado, $idrecepcion, $observacion, $responsable, $usuario, $tab,
           $lugar) {
      $con = new ConexionBD;
...
and (idedad=4 or idedad=$idedad);";
   ...
   //Fn PG
   function buscartodosexamens($solicitud) {
      $con = new ConexionBD;
      if ($con->conectar() == true) {
