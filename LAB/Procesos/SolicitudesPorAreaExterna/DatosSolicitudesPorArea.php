...
function Rechazar()
{
 ...
 idexamen=document.frmDatos.txtidexamen.value;
 //alert(idexamen);
 RechazarMuestra(idtipo,idexpediente,idarea,idsolicitud,fechasolicitud,observacion,idexamen);
...
<?php 
	...
	$idtipo=$_GET['var5'];
	$idExamen=$_GET['var4'];
	//echo $idexpediente."  ".$idsolicitud."  ".$lugar."  ".$idExamen;
	...
	//echo $idExamen;	
		...
		$consultadetalle=$objdatos->DatosDetalleSolicitud($idarea,$idsolicitud,$idtipo,$idExamen);?>
	<form name='frmDatos' onload='alert("si");'>
		...
		<tr>
			...
			<input name="idarea" id="idarea"  type="hidden" value="<?php $idarea ?>"/>
                        <input name="txtidexamen" id="txtidexamen"  type="hidden" value="<?php echo $idExamen ?>"/>
