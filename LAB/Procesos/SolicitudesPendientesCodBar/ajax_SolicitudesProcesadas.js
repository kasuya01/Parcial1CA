...
function ImprimirPlantillaB(idsolicitud,idexamen,responsable,procedencia,origen,observacion,valores_subelementos,codigos_subelementos,valores_elementos,codigos_elementos,controles,controles_ele,nombrearea,establecimiento,responsable,sexo,idedad){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaB.php?var1="+idsolicitud+
		"&var2="+idexamen+"&var3="+escape(responsable)+"&var4="+escape(procedencia)+
...
//alert(idsolicitud+"-"+idexamen+"-"+idresultado+"-"+idempleado);
	...
	"&var2="+idexamen+"&var3="+idresultado+"&var4="+idempleado+
	"&var5="+estab,"ImprimirD","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert (idarea);
 ventana_secundaria = window.open("ImprimirPlantillaE.php?var1="+idsolicitud+
				...
				"&var8="+codigos+
				"&var9="+encodeURIComponent(observacion)+"&var10="+escape(estab),"ImprimirE","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function MostrarResultadoExamen(idsolicitud,iddetalle,idarea,idexamen,resultado,lectura,interpretacion,observacion,responsable,nombrearea,procedencia,origen,impresion,establecimiento,codigo)
{
   ...
   //alert(codigo);
    ...
    "&interpretacion="+encodeURIComponent(interpretacion)+"&observacion="+encodeURIComponent(observacion)+
	"&responsable="+responsable+"&nombrearea="+escape(nombrearea)+"&procedencia="+escape(procedencia)+"&origen="+escape(origen)+
	"&impresion="+impresion+"&establecimiento="+establecimiento+"&codigo="+codigo);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	if (ajax.status == 200)
...
function GuardarResultadosPlantillaC()
{
   ...
   ajax.open("POST", "ctrDatosResultadosExamen_PC.php",true);
   ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
   ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+"&iddetalle="+iddetalle+
   "&observacion="+escape(observacion)+"&idempleado="+idempleado+"&valores_antibioticos="+encodeURIComponent(valores_antibioticos)+
   "&codigos_antibioticos="+codigos_antibioticos+"&idtarjeta="+idtarjeta+"&tiporespuesta="+tiporespuesta+"&idarea="+idarea+
   "&nombrearea="+escape(nombrearea)+"&resultado="+encodeURIComponent(resultado)+"&idbacteria="+idbacteria+
...
function GuardarResultadosPlantillaB()
{
  //  if(ValidarCamposPlantillaB())
 	//{
		...
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
	          "&iddetalle="+iddetalle+"&observacion="+encodeURIComponent(observacion)+"&idempleado="+idempleado+
			  "&procedencia="+procedencia+"&origen="+origen+"&valores_subelementos="+encodeURIComponent(valores_subelementos)+
...
function CargarElementosExamen(codigoex,fechanac,sexo)
{
    ajax=objetoAjax();
    idexamen=codigoex;
    FechaNac=fechanac;
...
function IngresarResultados()
{
	...
	if(validaempleado())
	{
		...
		CargarElementosExamen(codigoex,fechanac,sexo);
	}
	else
	{
		...
		switch (plantilla)
		 {  case "A":
		  if (idarea=="QUI"){
			  ventana_secundaria = window.open("ProcDatosResultadosExamen_PA1.php?var1="+idexpediente+
                    ...
                    ventana_secundaria = window.open("ProcDatosResultadosExamen_PA.php?var1="+idexpediente+
					 ...
					 "&var7="+paciente+
					 "&var8="+idrecepcion+"&var9="+escape(nombrearea)+
					 "&var10="+escape(procedencia)+"&var11="+escape(origen)+"&var12="+impresion+
					 "&var13="+estab,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
                     }
		  break;
		  case "B":
		  ventana_dos = window.open("ProcDatosResultadosExamen_PB.php?var1="+idexpediente+
					 ...
					 "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+"&var13="+estab+
                                         "&var14="+FechaNac+"&var15="+Sexo,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  break;
		  case "C":
		  ...
		  ventana_dos = window.open("ProcDatosResultadosExamen_PD.php?var1="+idexpediente+
					 ...
					 "&var13="+estab,"Resultados","width=950,height=700,menubar=no,scrollbars=yes") ;
		  break;
		 case "E":
		 ventana_dos = window.open("ProcDatosResultadosExamen_PE.php?var1="+idexpediente+
					 ...
					 "&var13="+estab+"&var14="+FechaNac+
                                         "&var15="+Sexo,"Resultados","width=950,height=950,menubar=no,scrollbars=yes") ;
		break;
		}
...
function SolicitudesPorAreaPendientes()
{
	...
	"&PNombre="+PNombre+"&SNombre="+SNombre+"&PApellido="+PApellido+
	"&SApellido="+SApellido+"&Codigo="+Codigo+"&Orden="+Orden+"&TipoSolic="+TipoSolic);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
...
function IngresarTodosResultados()
{
	...
	if(validaempleado())
	{
		...
		idarea=document.frmnuevo.txtarea.value;
                fechanac=document.frmnuevo.txtFechaNac.value;
                sexo=document.frmnuevo.txtSexo.value;
		CargarExamenes(idsolicitud,idarea,fechanac,sexo);
	}
	else
	{
		alert("Ingrese el nombre de Responsable");	
...
function MostrarVistaPreviaPlantillaE()
{
	if (ValidarCamposPlantillaE())
	{
		...
		"&idempleado="+idempleado+"&valores="+encodeURIComponent(valores)+"&codigos="+codigos+
		"&comentarios="+encodeURIComponent(comentarios)+"&estab="+estab+"&tab="+tab);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{	if (ajax.status == 200)
