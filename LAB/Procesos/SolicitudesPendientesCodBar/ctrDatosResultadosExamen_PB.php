...
//echo $IdEstandar;
	     ...
	     $imprimir="<table width='92%' align='center'class='StormyWeatherFormTABLE' >
			   ...
			   <tr>
				...
				<td colspan='2'>".htmlentities( $establecimiento)."</td>
                                <td colspan='1' style='font:bold'><strong>Fecha Recepci�n:</strong></td>
			   ...
			   <tr>
				...
				$nomcod=$objdatos->ObtenerNombreCodigo($tab);
                                $row_codigo= mysql_fetch_array($nomcod);
										// echo $row_codigo[0];
               $imprimir.="<tr><td style='font:bold' >Resultado Tabulador:</td>
                               <td colspan='4'>".$row_codigo[0]."</td></tr>
		</table>";
	   ...
	   $imprimir.= "<tr>
		...
		default:
			...
			$imprimir="<br><table width='95%' border='0' align='center' class='StormyWeatherFormTABLE'>
				<tr>
				 	<td align='center' colspan='6' class='CobaltButton'>
				 	<p><strong>RESULTADOS LABORATORIO CL&Iacute;NICO</strong></p>
				...
				<tr>	
					...
					<td colspan='1'>&nbsp;&nbsp;&nbsp;</td>
					<td colspan='1' style='font:bold'><strong>Servicio:</strong></td>
					<td  style='font:bold'colspan='2'>".htmlentities($row_generales['Origen'])."</td>
				</tr>
				<tr>
					 <td colspan='1' style='font:bold'><strong>Examen Realizado:</strong></td>
					 <td colspan='4'style='font:bold'>".htmlentities($row_area['NombreExamen'])."</td>
				 ...
				 <tr>
					 ...
					 <td colspan='4'>".htmlentities($observacion)."</td>
                        ...
                        $row_codigo= mysql_fetch_array($nomcod);
							// echo $row_codigo[0];
		     $imprimir.="<tr>
                                    <td style='font:bold' >Resultado Tabulador:</td><td colspan='4'>".$row_codigo[0]."</td></tr>
				 </table>";
	
		     $imprimir.="<table width='95%' border='0' align='center' class='StormyWeatherFormTABLE'>
				 <tr>
                                    <td>";
			$imprimir.= "<tr class='CobaltButton'>
				<td width='25%'></td>
