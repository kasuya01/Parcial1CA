   ...
   case 2://MOSTRANDO VISTA PREVIA DE LOS RESULTADO POSITIVOS INGRESADOS
        ...
        $imprimir="<table width='75%' border='0' align='center' class='StormyWeatherFormTABLE'>
			...
			<tr>
				...
				<td colspan='4'>".$row_generales['IdNumeroExp']."</td>
				
				
			</tr>
			<tr>
				<td colspan='1' style='font:bold'><strong>Paciente:</strong></td>
				<td colspan='4'>".htmlentities($row_generales['NombrePaciente'])."</td>
			...
			<tr>
				<td  style='font:bold' colspan='2' class='StormyWeatherFieldCaptionTD'><strong>CULTIVO CON CUENTA DE COLONIAS</strong></td>
				<td  colspan='4' class='StormyWeatherDataTD'>".htmlentities($cantidad)."</td>
			</tr>
                        <tr class='CobaltButton'>	
				<td colspan='2' style='font:bold' ><strong>ANTIBIOTICO</strong></td>
				<td colspan='4' style='font:bold' ><strong>INTERPRETACI&Oacute;N</strong></td>
			</tr>";
			...
			{
		$imprimir.="<tr>
					<td colspan='2'>".$row['Antibiotico']."</td>
					<td colspan='4'>".htmlentities($vector_valores[$pos]).
						"<input name='oidantibiotico[".$pos."]' type='hidden' id='oidantibiotico[".$pos."]' value='".$row['IdAntibiotico']."'>
					</td>
		 	</tr>";
				$pos=$pos+1;		
	     ...
	     $imprimir.="<tr>
			...
			<tr>
				<td colspan='5'>
					...
					<input type='button' name='Imprimir'  id='Imprimir' value='Imprimir' Onclick='ImprimirPlantillaC(".$idsolicitud.",\"".$idexamen."\",\"".htmlentities($resultado)."\",\"".htmlentities($row_empleado['NombreEmpleado'])."\",\"".htmlentities($row_generales['Procedencia'])."\",\"".htmlentities($row_generales['Origen'])."\",\"".htmlentities($observacion)."\",\"".htmlentities($valores_antibioticos)."\",\"".$codigos_antibioticos."\",".$idbacteria.",\"".htmlentities($cantidad)."\",".$idtarjeta.",\"".htmlentities($row_area['NombreArea'])."\",\"".htmlentities($establecimiento)."\") ;' />
