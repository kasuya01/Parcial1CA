...
<tr>
	<td>
		...
		<table width='80%' border='0' align='center' class='StormyWeatherFormTABLE'>
			<tr>
				<td align='center' colspan='5' class='CobaltFieldCaptionTD'>
			...
			<tr>
				...
				<td colspan='4'><?php echo $row_generales['IdNumeroExp']?></td>
			...
			<tr>
				...
				<td colspan='4'><?php echo htmlentities($row_generales['NombrePaciente'])?></td>
			...
			<tr>
				...
				<td colspan='1'><?php echo $row_generales['Sexo']?></td></tr>			
			<tr>
