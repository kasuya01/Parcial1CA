...
<?php
	...
	case "H50":
		...
		<tr>
			...
			<td colspan='2' class="Estilo6" width="40%"><?php echo htmlentities($row_generales['estabext'])?></td>
			<td colspan='1' class="Estilo5" width="19%"><strong>Fecha Resultado:</strong></td>
			<td colspan='2' class="Estilo6" width="13%"><?php echo $row_fecha['fecharesultado']?></td>
		</tr>
	...
	default:
		...
		?>
	  	<table width="100%" border="0" align="center" cellpadding="0%"  cellspacing="0%" >
			...
			<td colspan="3" class="Estilo6" width="39%" align="left"><?php echo htmlentities($row_generales['estabext'])?></td>
			...
			<td colspan="1" class="Estilo6" align="left" ><?php echo htmlentities($row_generales['nombreservicio'])?></td>
                    </tr>
                    <tr>
			...
			<td colspan="5" class="Estilo6" align="left"><?php echo htmlentities($row_generales['empleado'])?></td>
                    ...
                    while($row = pg_fetch_array($consulta))//ELEMENTOS
                    {
                            ...
                            {   ?>
                                ...
                                ?>
                               <tr>
                                    <td width="25%" class="Estilo5" align="justify"><?php echo htmlentities($rowsub['subelemento'])?></td>
                               <?php 
                                 if(!empty($rowsub['resultado'])){ ?>
                      ...
                      <?php  } ?>
                            ...
                            {?>
                                <tr>
                                    ...
                                    <td colspan="1" align="justify"><?php echo htmlentities($vector_elementos[$posele])?></td>
                                    <td colspan="1" class="Estilo6" align="justify"><?php utf8_encode($row['unidadelem'])?></td>
                                </tr>
                                  <?php
                                         $posele=$posele+1;
                                       ?>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="Estilo6"  width="80%"lign="justify"><?php echo $row_generales['observacion']?></td>
                                </tr>
