...
function ImprimirPlantillaA(idsolicitud,idexamen,detallesolicitud,idarea,resultado,lectura,interpretacion,observacion,responsable,procedencia,origen,idbacteria){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaA.php?var1="+idsolicitud+
	...
	"&var5="+encodeURIComponent(resultado)+"&var6="+encodeURIComponent(lectura)+"&var7="+encodeURIComponent(interpretacion)+
...
function ImprimirPlantillaC(idsolicitud,idexamen,resultado,responsable,procedencia,origen,observacion,valores_antibioticos,codigos_antibioticos,idbacteria,cantidad,idtarjeta,nombrearea,estab){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaC.php?var1="+idsolicitud+
	 ...
	 "&var4="+responsable+"&var5="+escape(procedencia)+
	 ...
	 "&var13="+escape(nombrearea)+"&var14="+escape(estab),"ImprimirC","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert(idsolicitud+"-"+idexamen+"-"+idresultado+"-"+idempleado);
	...
	"&var2="+idexamen+"&var3="+idresultado+
        "&var4="+idempleado+"&var5="+estab,"ImprimirD","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function ImprimirPlantillaE(idsolicitud,idexamen,responsable,procedencia,origen,cometarios,valores,codigo,observacion,estab,sexo,idedad){
	...
	"&var8="+codigo+"&var9="+encodeURIComponent(observacion)+
		...
		switch (plantilla)
		 {  case "A":
		  if (idarea=="QUI"){
                            ...
                            "&var7="+escape(paciente)+"&var8="+idrecepcion+"&var9="+nombrearea+"&var10="+procedencia+"&var11="+origen+
                            "&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                            "&var17="+IdHistorial,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
			 }
		  else{
                            ventana_secundaria = window.open("ProcDatosResultadosExamen_PA.php?var1="+idexpediente+
                            "&var2="+escape(examen)+"&var3="+idexamen+"&var4="+idarea+"&var5="+detallesolicitud+"&var6="+idsolicitud+
                            "&var7="+paciente+"&var8="+idrecepcion+"&var9="+nombrearea+"&var10="+escape(procedencia)+"&var11="+escape(origen)+
                            "&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                            "&var17="+IdHistorial,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
				 }
		  break;
		  ...
		  ventana_dos = window.open("ProcDatosResultadosExamen_PB.php?var1="+idexpediente+
					...
					"&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                                        ...
                                        "&var15="+Sexo+"&var16="+IdEstandar+"&var17="+IdHistorial,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  break;
		  case "C":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PC.php?var1="+idexpediente+
                            ...
                            "&var9="+nombrearea+
                            "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                            "&var13="+estab+"&var16="+IdEstandar+"&var17="+IdHistorial,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  break;
		  case "D":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PD.php?var1="+idexpediente+
                            "&var2="+examen+"&var3="+idexamen+"&var4="+idarea+
                            "&var5="+detallesolicitud+"&var6="+idsolicitud+
                            "&var7="+paciente+"&var8="+idrecepcion+"&var9="+nombrearea+
                            "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                            "&var13="+estab+"&var14="+IdEstandar+
                            "&var17="+IdHistorial,"Resultados","width=950,height=700,menubar=no,scrollbars=yes") ;
		  break;
		 case "E":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PE.php?var1="+idexpediente+
                            ...
                            "&var17="+IdHistorial,"Resultados","width=950,height=950,menubar=no,scrollbars=yes") ;
		break;
		}
...
function GuardarPlantillaD()
{
	...
	else{alert("Complete la Información requerida");}
}
...
function IngresarResultadosPlantillaE()
{
	if(validaempleado())
	{
		codigoex=document.frmnuevo.txtidexamen.value;
                ...
                sexo=document.frmnuevo.txtSexo.value;
                idestandar=document.frmnuevo.txtIdEstandar.value;
		CargarProcesosExamen(codigoex,fechanac,sexo,idestandar);
	}
	else
	{
		alert("Ingrese el nombre de Responsable");	
...
function CargarProcesosExamen(codigoex,fechanac,sexo,idestandar)
{
    ajax=objetoAjax();
        idexamen=codigoex;
	opcion=1;
	...
	ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
	          "&iddetalle="+iddetalle+"&observacion="+observacion+"&idempleado="+idempleado+
                  "&valores="+valores+"&codigos="+codigos+"&comentarios="+comentarios+"&fechanac="+fechanac+
                  "&sexo="+sexo+"&IdEstandar="+idestandar);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
