                ...
                <tr>
                    <td  colspan="6">
                        ...
                        while($rowdet = mysql_fetch_array($consulta)){?>
                                ...
                                ?>     	<td align="center" class="Estilo6"><?php echo htmlentities($vector_resultados[$pos])?></td>
                                        <td align="center" class="Estilo6"><?php echo htmlentities($rowdet['Unidades'])?></td>
                                        <td align="center" class="Estilo6"><?php echo $rowdet['RangoInicio']." - ".$rowdet['RangoFin']?></td>
                                        <td class="Estilo6"><?php echo htmlentities($vector_lecturas[$pos])?></td>
                                        <td class="Estilo6" ><?php echo htmlentities($vector_inter[$pos])?></td>
                                        <td class="Estilo6" ><?php echo htmlentities($vector_obser[$pos])?></td>
                                </tr>
                                <?php
                                      }
                                        $pos=$pos + 1;
