...
//creando los objetos de las clases
	...
	if ($IdEstandar=="H15"){   
		...
		<table width='100%' border='0' align='center' >
                    <tr>
                        ...
                        <td align='center' colspan='4' class='CobaltFieldCaptionTD' class="Estilo6">
	...
	?>
		<table width="100%" border="0" align="center" class="StormyWeatherFormTABLE" cellspacing="0" >
			...
			<tr>
				<td colspan="1" class="Estilo5"><strong>Observaci&oacute;n:</strong></td>
				<td colspan="5" class="Estilo6" colspan="4"><?php echo htmlentities($observacion)?></td>
			</tr>
                        <tr>
                                <td colspan="6" align='center' >&nbsp;&nbsp;&nbsp;</td>
                        </tr>
			...
			?>
						...
						<td class="Estilo5" align="center"><strong> Resultado</strong> </td>
                                                <td class="Estilo5" align="center"> <strong>Unidades </strong></td>
						<td class="Estilo5" align="center"> <strong>Rango de Referencia</strong> </td>
					</tr>
                                   <?php $pos=0;
                                     while($row = mysql_fetch_array($consulta))//ELEMENTOS
                                            {  ?>
