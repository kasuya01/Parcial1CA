   ...
   switch (idplantilla)
	{ 	case "A":
			...
			/*if (idarea=="QUI" || idarea=="HEM" || idarea=="INM"){*/
				ventana_secundaria = window.open("ImprimirPlantillaA1.php?var1="+iddetalle+"&var2="+idsolicitud+
                                "&var3="+idplantilla+"&var4="+idexpediente+"&var5="+idarea+"&var6="+sexo+"&var7="+fechanac,
                                "Impresion","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
					 //calc_edad();
			/*}
			else{
				ventana_secundaria = window.open("ImprimirPlantillaA.php?var1="+iddetalle+"&var2="+idsolicitud+"&var3="+idplantilla+"&var4="+idexpediente+"&var5="+idarea+"&var6="+idexamen,"Impresion","width=1150,ccc=800,menubar=no,scrollbars=yes,location=no");
