...
<script language="JavaScript" type="text/javascript" src="ajax_EliminarSolicitud.js"></script>
            ...
            <div  id="divInicial" >
                <form enctype="multipart/form-data">
                    ...
                    <table align="center"  class="StormyWeatherFormTABLE" width="67%">
                        <tr>
                            <td colspan="5" align="center" class="CobaltFieldCaptionTD"><h3><strong>Eliminar Solicitud</strong></h3></td>
                        </tr>
                        <tr>		
                                    ...
                                    <td class="StormyWeatherDataTD">
                                            <select name="CmbServicio" id="CmbServicio" style="width:443px" onChange="BuscarServicio(this.value)"  class="form-control height">
                                                    <option value="0" selected="selected" align="center"> Seleccione Procedencia </option>
                                                            ...
                                                            $db = new ConexionBD;
                                                            if($db->conectar()==true){
                                                                 echo    $consulta  = " SELECT mnt_area_mod_estab.id as codigo ,CASE WHEN id_servicio_externo_estab IS NOT NULL THEN mnt_servicio_externo.abreviatura ||'-->'  || ctl_area_atencion.nombre                               ELSE   ctl_modalidad.nombre ||'-->' || ctl_area_atencion.nombre
                                                       END
                            ...
                            <tr>
                                <td class="StormyWeatherDataTD" colspan="4" align="right">
                                    ...
                                    <button type='button' align="center" class='btn btn-primary' id='nuevabusqueda' onclick="window.location.replace('EliminarSolicitud.php')"><span class='glyphicon glyphicon-refresh'></span> Nueva Busqueda</button>
                                </td>
                            </tr>
