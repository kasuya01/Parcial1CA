...
function CambiarEstadoDetalleSolicitud(estado,idtipo,idexpediente,idarea,idsolicitud)
{
		...
		//alert("Cambiar"+idsolicitud+"*"+idtipo+"*"+idexpediente+"*"+idarea+"*"+estado+"fechasolicitud");
		...
		ajax.send("idexpediente="+idexpediente+"&idarea="+idarea+
		"&fechasolicitud="+fechasolicitud+"&idsolicitud="+idsolicitud+"&opcion="+opcion+
		"&estado="+estado+"&idexamen="+idexamen+"&idtipo="+idtipo+"&pag="+pag);	
...
function CambiarEstadoDetalleSolicitud1(estado,idexamen)
{
		...
		ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		//enviando los valores
		ajax.send("idexpediente="+idexpediente+"&idarea="+idarea+"&fechasolicitud="+fechasolicitud+"&idsolicitud="+idsolicitud+"&opcion="+opcion+"&estado="+estado+"&idexamen="+idexamen+"&pag="+pag);	
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{
...
function RechazarMuestra(idtipo,idexpediente,idarea,idsolicitud,fechasolicitud,observacion)
{
   estado='RM'
	...
	ajax.send("idexpediente="+idexpediente+"&idarea="+idarea+"&fechasolicitud="+fechasolicitud+"&idsolicitud="+idsolicitud+
	"&opcion="+opcion+"&estado="+estado+"&observacion="+escape(observacion)+"&idtipo="+idtipo);	
...
function SolicitudesPorArea()
{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		  //enviando los valores
	ajax.send("opcion="+opcion+"&IdEstab="+IdEstab+"&IdServ="+IdServ+"&IdSubServ="+IdSubServ+"&idarea="+idarea+"&idexpediente="+idexpediente+
	"&idexamen="+idexamen+"&PNombre="+PNombre+"&SNombre="+SNombre+"&PApellido="+PApellido+"&SApellido="+SApellido+"&fechasolicitud="+fechasolicitud+
