				...
				<form name="frmnuevo" method="get" action="ProcDatosResultadosExamen_PA.php" enctype="multipart/form-data">
					<table width="70%" border="0" align="center" class="StormyWeatherFormTABLE">
						...
						<tr>
							...
							<td width="83%" class="StormyWeatherDataTD"><?php echo $_GET['var7'] ?>
						...
						<tr>
							...
							<td width="83%" class="StormyWeatherDataTD"><?php echo $_GET['var9'] ?>
						...
						<tr>
							...
							<td width="83%" class="StormyWeatherDataTD"><?php echo $_GET['var2'] ?>
						...
						if ($bandera==1){
								?>
						<tr>
							<td colspan="2"  class="StormyWeatherDataTD" align="center" style="color:#DD0000; font:bold">
