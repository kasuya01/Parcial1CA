...
<table width="60%" border="0" align="center" class="StormyWeatherFormTABLE">
	...
	<tr>
        	<td width="20%" class="StormyWeatherFieldCaptionTD">NEC</td>
            	<td width="88%" class="StormyWeatherDataTD"><?php echo $_GET['var1'] ?>
	...
	<tr>
        	<td width="20%" class="StormyWeatherFieldCaptionTD">Paciente</td>
            	<td width="80%" class="StormyWeatherDataTD"><?php echo $_GET['var7'] ?>
             		<input type="hidden" name="txtpaciente" id="txtpaciente" disabled="disabled" size="60" />
		</td>
        </tr>
	<tr>
        	<td width="20%" class="StormyWeatherFieldCaptionTD">&Aacute;rea</td>
            	<td width="80%" class="StormyWeatherDataTD"><?php echo $_GET['var9'] ?>
			<input type="hidden" name="txtnombrearea" id="txtnombrearea" disabled="disabled" size="60" />
		</td>
        </tr>
        <tr>
        	<td width="20%" class="StormyWeatherFieldCaptionTD">Examen </td>
            	<td width="80%" class="StormyWeatherDataTD"><?php echo $_GET['var2'] ?>
           		<input type="hidden" name="txtexamen" id="txtexamen" disabled="disabled" size="60" />
		</td>
        </tr>
	<tr>
	        <td width="20%" class="StormyWeatherFieldCaptionTD">*Validado Por</td>
	...
	<tr>
		<td width="20%" class="StormyWeatherFieldCaptionTD">Observaci&oacute;n </td>
		<td width="80%" class="StormyWeatherDataTD">
	...
	<tr>
		<td colspan="2" align="center" class="StormyWeatherDataTD" style="color:#DD0000; font:bold">
		  ...
		  <tr>
		  <td colspan="2" class="StormyWeatherDataTD" 	align="rigth"><input type="button" name="Submit" value="Ingresar Resultados" Onclick="IngresarResultadosPlantillaE() ;">  </td>
		  </td>
		  </tr>
	</table>
</form>
