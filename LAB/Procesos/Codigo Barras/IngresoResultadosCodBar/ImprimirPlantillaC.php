...
?>
	<table width='80%' border='0' align='center' class='StormyWeatherFormTABLE'>
		...
		<tr>
			...
			<td colspan='1' style='font:bold'><strong>Fecha:</strong></td>
		  	<td colspan='1' colspan='1'><?php echo $row_generales['Fecha']?></td>
		...
		<tr>	
			...
			<td colspan='3' style='font:bold' ><?php echo htmlentities($origen);?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan='4'><?php echo $responsable;?></td>
		</tr>
		<tr>
			<td colspan='6'>&nbsp;</td>
		</tr>
	...
	<table width='80%' border='0' align='center' class='StormyWeatherFormTABLE'>
			<tr>
				<td class='StormyWeatherFieldCaptionTD'>CULTIVO CON CUENTA DE COLONIAS</td>
