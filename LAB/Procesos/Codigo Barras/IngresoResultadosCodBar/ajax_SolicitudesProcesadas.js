...
function ImprimirPlantillaA(idsolicitud,idexamen,resultado,lectura,interpretacion,observacion,responsable){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaA.php?var1="+idsolicitud+
			 "&var2="+idexamen+"&var3="+
			 "&var3="+escape(resultado)+"&var4="+escape(lectura)+"&var5="+escape(interpretacion)+"&var6="+escape(observacion)+"&var7="+responsable,"ImprimirA","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert (establecimiento);
 ventana_secundaria = window.open("ImprimirPlantillaA1.php?var1="+idsolicitud+
				...
				"&var4="+escape(valores_resultados)+"&var5="+codigos_resultados+
				"&var6="+escape(valores_lecturas)+"&var7="+escape(valores_inter)+"&var8="+escape(valores_obser)+"&var9="+codigos_examenes+"&var10="+escape(establecimiento),"ImprimirA1","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
}
...
function ImprimirPlantillaCN(idsolicitud,idexamen,idarea,resultado,responsable,procedencia,origen,observacion){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaCN.php?var1="+idsolicitud+
	...
	"&var7="+escape(origen)+"&var8="+escape(observacion)+"&var9="+escape(estab),"ImprimirCN","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//alert (idarea);
 ventana_secundaria = window.open("ImprimirPlantillaE.php?var1="+idsolicitud+
		...
		"&var8="+codigos+"&var9="+escape(observacion)+
...
function MostrarResultadoExamen(idsolicitud,iddetalle,idarea,idexamen,resultado,lectura,interpretacion,observacion,responsable,nombrearea,procedencia,origen,impresion,establecimiento,codigo)
{
 ...
 //alert (codresult);
	ajax.send("opcion="+opcion+"&idarea="+area+
		  ...
		  "&resultado="+escape(resultado)+"&lectura="+escape(lectura)+"&interpretacion="+escape(interpretacion)+
		  "&observacion="+escape(observacion)+"&responsable="+escape(responsable)+"&nombrearea="+escape(nombrearea)+
  ...
  if (ValidarCamposPlantillaB())
  {
	...
	//{
		...
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
		  ...
		  "&controles_ele="+escape(controles_ele)+"&estab="+escape(estab)+"&tab="+tab);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{	 if (ajax.status == 200)
...
function MostrarDatos(posicion)
{
		...
		{ 	case "A":
				if (idarea=="QUI"){
					...
					"&var12="+impresion+"&var13="+estab,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
				}
				else{
...
function GuardarPlantillaE()
{
	...
	ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
			  ...
			  +"&valores="+escape(valores)+"&codigos="+codigos+"&comentarios="+escape(comentarios)+"&tab="+tab);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
