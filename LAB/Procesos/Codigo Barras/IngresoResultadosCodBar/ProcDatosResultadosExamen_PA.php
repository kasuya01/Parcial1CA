...
<form name="frmnuevo" method="get" action="ProcDatosResultadosExamen_PA.php" enctype="multipart/form-data">
	<table width="70%" border="0" align="center" class="StormyWeatherFormTABLE">
		...
		<tr>
             ...
             <td width="65%" class="StormyWeatherDataTD"><?php echo htmlentities($_GET['var7']);?>
		...
		<tr>
            ...
            <td width="65%" class="StormyWeatherDataTD"> <?php echo htmlentities($_GET['var9']) ;?>
						<input type="hidden" name="txtnombrearea" id="txtnombrearea" disabled="disabled" size="60" />
			</td>
        </tr>
        <tr>
            <td class="StormyWeatherFieldCaptionTD">Examen </td>
            <td width="65%" class="StormyWeatherDataTD"> <?php echo htmlentities($_GET['var2']);?>
		...
		<tr>
             ...
             <td width="65%" class="StormyWeatherDataTD"><textarea name="txtlectura" cols="50" id="txtlectura"></textarea></td>
        </tr>
		<tr>
			<td  class="StormyWeatherFieldCaptionTD">Interpretaci&oacute;n</td>
		    <td width="65%" class="StormyWeatherDataTD"><textarea name="txtinterpretacion" cols="50" id="txtinterpretacion"></textarea></td>
	   </tr>
	   <tr>
            <td class="StormyWeatherFieldCaptionTD">Observaci&oacute;n</td>
            <td width="65%" class="StormyWeatherDataTD"><textarea name="txtcomentario" cols="50" id="txtcomentario"></textarea></td>
        </tr>
		<tr>
