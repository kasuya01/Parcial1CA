...
{
	if ((document.getElementById('cmbTipoEstab').value == 0) && (document.getElementById('cmbEstablecimiento').value == 0) && (document.getElementById('CmbServicio').value == 0) 
	&& (document.getElementById('cmbArea').value == 0) && (document.getElementById('txtexpediente').value == "") && (document.getElementById('cmbExamen').value == 0) 
	&& (document.getElementById('PrimerNombre').value=="") && (document.getElementById('SegundoNombre').value=="") && (document.geElementById('PrimerApellido').value=="") 
	&& (document.getElementById('SegundoApellido').value=="") && (document.getElementById('txtfechasolicitud').value=="") && (document.getElementById('Codigo').value=="")
	&& (document.getElementById('Orden').value==""))
	{
		...
		if (document.getElementById('cmbArea').value == 0) {
			if (document.getElementById('Codigo').value =="")
				alert("Debe de ingresar un Área o Codigo ");
			else
				SolicitudesPorArea();
		}
        else{
...
<form name="frmnuevo" id="frmnuevo" action="" onSubmit="MostrarSolicitudes();return false">
	<table  align="center" class="StormyWeatherFormTABLE" width="79%">
  		<tr>
		...
		<tr>		
			...
			<td class="StormyWeatherDataTD"><select name="cmbTipoEstab" id="cmbTipoEstab" style="width:355px" onChange="BuscarEstablecimiento(this.value)">
