...
<?php 
  ...
  // echo $FRecepcion;
	...
	<tr>
		<td colspan='5' align='center' class='CobaltFieldCaptionTD'>DATOS SOLICITUD</td>
	</tr>
        <tr>	<td width="15%">Establecimiento:</td>
		<td width="30%" colspan="4"><?php echo $Establecimiento?></td>
	</tr>
	<tr>
	  <td width="15%">NEC</td>
	  <td width="30%"><?php echo $idexpediente?></td>
	  <td colspan="2">N&uacute;mero de Muestra &nbsp;&nbsp;&nbsp;</td>
	  <td width="15%"><?php echo $muestra?></td>
	</tr>
	<tr>
	    <td width="15%">Procedencia</td>
	    <td><?php echo $precedencia?></td>
	    <td width="11%">Origen</td>
	    <td colspan="2"><?php echo htmlentities($origen) ?>
			...
			<input name="idarea" id="idarea"  type="hidden" value="<?php $idarea ?>"/>	<input name="suEdad" id="suEdad"  type="hidden" value="<?php echo $row['FechaNacimiento'] ?>"/>	
			</td>

	</tr>
	<tr>
		<td width="15%" >M&eacute;dico</td>
		<td colspan="4"><?php echo htmlentities($medico)?></td>
	</tr>
	<tr>
	    <td  width="15%">Paciente</td>
	    <td colspan="2" ><?php echo htmlentities($paciente)?> </td>
	    <td width="21%" >Fecha Recepci&oacute;n </td>
