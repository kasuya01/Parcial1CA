...
function MostrarSolicitudesPendientes()
{
	...
	&& (document.getElementById('txtfecharecep').value == "") && (document.getElementById('cmbEstablecimiento').value == 0) 
	...
	&& (document.getElementById('Codigo').value=="") && (document.getElementById('Orden').value=="")){
		...
		if ((document.getElementById('cmbArea').value == 0) && (document.getElementById('Codigo').value == "")){
	...
	/*{
		if (document.getElementById('cmbArea').value == 0) {
			if (document.getElementById('Codigo').value =="")
				alert("Debe de ingresar al menos una Área o Codigo");
			else
...
<form name="frmnuevo" id="frmnuevo" action="" onSubmit="MostrarSolicitudesPendientes();return false">
	...
	<table  align="center" class="StormyWeatherFormTABLE" width="85%">
		<tr>
			<td colspan="4" align="center" class="CobaltFieldCaptionTD"><h3><strong>Muestras Pendientes de Procesar por &Aacute;rea</strong></h3>
			</td>
		</tr>
		<tr>
			...
			<td class="StormyWeatherDataTD" colspan="1"><input class="MailboxInput" maxlength="25" size="20" name="Orden" id="Orden"></td>
		</tr>
		<tr>		
			<td class="StormyWeatherFieldCaptionTD">Tipo Establecimiento</td>
			<td class="StormyWeatherDataTD">
				<select name="cmbTipoEstab" id="cmbTipoEstab" style="width:355px" onChange="BuscarEstablecimiento(this.value)">
		...
		<tr>
			<td class="StormyWeatherFieldCaptionTD" style="font-weight:bold" width="15%">
		...
		<tr>
			...
			<td class="StormyWeatherDataTD" width="4%" ><input type="text" size="24" name="txtexpediente" id="txtexpediente" /></td>
			<td class="StormyWeatherFieldCaptionTD" width="15%" >Fecha Recepi&oacute;n</td>
			<td  class="StormyWeatherDataTD" width="29%" ><input type="text" size="15" name="txtfecharecep" id="txtfecharecep" />
		...
		<tr>
			<td  class="StormyWeatherDataTD" colspan="4" align="right">
				...
				<input type="button" id="btnClear" value="Nueva Busqueda" class="MailboxButton" onClick="window.location.replace('Proc_MuestrasPendientes.php')">
			</td>
		<tr>
	</table>
</form>
