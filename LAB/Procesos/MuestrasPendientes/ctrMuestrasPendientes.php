...
switch ($opcion) 
{
  case 1: 
	...
	//echo $query_search;
	  ...
	  echo "<table width='85%' border='1' align='center' class='StormyWeatherFormTABLE'>
	 ...
	 //$row = mysql_fetch_array($consulta);
   	...
   	case 2:
			...
			//echo $idarea."-".$idsolicitud."-".$idexamen;
		 ...
		 <tr>
		  ...
		  <tr>
		    ...
		    <td class='StormyWeatherDataTD'>
                        ...
                        <input type='hidden' name='txtedad' value='". $edad."' disabled='disabled' /></td>
		    <td class='StormyWeatherFieldCaptionTD'>Sexo</td>
		    <td class='StormyWeatherDataTD'>$sexo
                        <input type='hidden' name='txtsexo' value='".$sexo."' disabled='disabled' />
                     </td>
		 </tr>
                 <tr>
		    <td class='StormyWeatherFieldCaptionTD'>Procedencia</td>
