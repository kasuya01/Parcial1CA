...
//alert (establecimiento);
 ventana_secundaria = window.open("ImprimirPlantillaA1.php?var1="+idsolicitud+
				...
				"&var6="+escape(valores_lecturas)+"&var7="+encodeURIComponent(valores_inter)+
				"&var8="+encodeURIComponent(valores_obser)+"&var9="+codigos_examenes+
				"&var10="+escape(establecimiento)+"&var11="+sexo+"&var12="+idedad,"ImprimirA1","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
}
...
//alert (idarea);
 ventana_secundaria = window.open("ImprimirPlantillaE.php?var1="+idsolicitud+
	...
	"&var10="+escape(estab)+"&var11="+sexo+"&var12="+idedad,"ImprimirE","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function MostrarDatos(posicion)
{
		...
		{ 	case "A":
		  	...
		  	case "B":
				...
				"&var7="+paciente+"&var8="+idrecepcion+"&var9="+nombrearea+"&var10="+procedencia+"&var11="+origen+
				"&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                                "&var17="+IdHistorial,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no");
		  	break;
		  	case "C":
				...
				"&var12="+impresion+"&var13="+estab+"&var16="+IdEstandar+
                                "&var17="+IdHistorial,"Resultados","width=950,height=650,menubar=no,scrollbars=yes,location=no") ;
		  	break;
		  	case "D":
