...
<?php 	
	...
	//echo $responsable;
	?>
	<table width='97%' border='0' align='center' class='StormyWeatherFormTABLE'>
		<tr>
			<td colspan="1" align="left" width="20%"><img id="Image1" style="WIDTH: 80px; HEIGHT: 55px" height="86" src="../../../Imagenes/escudo1.png" width="210" name="Image1"></td>
		...
		<tr>
			<td colspan='1' class="Estilo6"><strong>Establecimiednto Solicitante:</strong></td>
		...
		<tr> 
	        ...
	        ?>
				...
				while($row = mysql_fetch_array($consulta))//ELEMENTOS
					{  ?>
				<tr>
					<td class="Estilo6" width='25%'align='left'><?php echo htmlentities($row['nombreprocedimiento'])?></td>
					<td class="Estilo6" width='30%'align='center'><input name='oidprueba[<?php $pos?>]' type='hidden' id='oidprueba[<?php $pos?>]' value='<?php $row['idprocedimientoporexamen']?>'><?php echo htmlentities($vector_respuesta[$pos])?></td>
					<td class="Estilo6" width='20%'align='center'><?php echo htmlentities($row['unidades'])?></td>
                                        
					<td class="Estilo6" align='center' width='30%'><?php 
