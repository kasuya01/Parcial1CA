...
<?php 
    ...
    <div  id="divImpresion1" >
		...
		<tr>	
			...
			<td colspan='1' class="Estilo6"><?php echo $row_generales['Procedencia']?></td>
			 ...
			 <td colspan='4' class="Estilo6"><?php echo htmlentities($observacion)?></td>
                ...
                <tr> <td colspan='5'>
                        ...
                        <tr class='CobaltButton'>
                                ...
                                <td width='60%' colspan='2' class="Estilo5">Control Normal </td>
                        </tr>
                                <?php $pos=0;
                                        $posele=0;
                ...
                <?php	}else{?>
                        <tr>
                                ...
                                <td class="Estilo6"><?php echo htmlentities($vector_controles_ele[$posele])."  ".htmlentities($row['UnidadElem'])?></td>
                        </tr>
                        <?php	$posele=$posele+1;?>
                        <tr>
                        ...
                        <tr>
                                <td colspan='6' class="Estilo6">&nbsp;</td></tr>
                        </table>
                <?php	}	
...
<div  id="divImpresion" >
        ...
        <tr>
            <td colspan='6'>
                <table width='100%' border='0' align='center' class='StormyWeatherFormTABLE' Cellpadding="0"  cellspacing="0">
                    <tr class='CobaltButton'>
                        <td width='25%' class="Estilo6"></td>
                        <td width='20%' class="Estilo6"><strong>Resultado</strong></td>
                        <td width='15%' class="Estilo6"><strong>Unidades</strong></td>
                        <td width='30%' class="Estilo6"><strong>Rangos de Referencia</strong></td>
                    </tr>
                    <?php $pos=0;
                          $posele=0;
	while($row = mysql_fetch_array($consulta))//ELEMENTOS
	{  
		...
		{?>
                    <tr>
                        <td width='25%' class="Estilo6"><?php echo htmlentities($rowsub['SubElemento'])?></td>
			<td width='20%' class="Estilo6"><?php echo htmlentities($vector[$pos])?>
			</td>
			<td width='15%' class="Estilo6"><?php echo htmlentities($rowsub['Unidad'])?></td>
          <?php   if ((!empty($rowsub['rangoinicio'])) AND (!empty($rowsub['rangofin']))){?>
                        <td width='30%' class="Estilo6"><?php echo $rowsub['rangoinicio']." - ".$rowsub['rangofin']?></td> 
            <?php }else{?>  
		...
		?>
			...
			{?>
                    <tr>
			<td class="Estilo6" class='StormyWeatherFieldCaptionTD'><?php echo htmlentities($row['Elemento'])?></td>
			<td class="Estilo6"><?php echo htmlentities($vector_elementos[$posele])?></td>
