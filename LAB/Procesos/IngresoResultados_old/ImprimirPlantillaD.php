		...
		<tr>
			<td colspan='1'>&nbsp;</td>
				...
				<table width='110%' border='0' aling='center' cellspacing="0">
                                    <tr>
                                        <td width='50%' style='font:bold' class="Estilo5" aling='center' ><strong>Elemento de Tinci&oacute;n</strong>
					</td>
					<td width='50%' style='font:bold' class="Estilo5" aling='center' ><strong>Cantidad</strong>
					</td>
                                    </tr>
