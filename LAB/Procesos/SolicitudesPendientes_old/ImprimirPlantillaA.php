...
.Estilo5 {font-size: 9.5pt}
.Estilo6 {font-size: 8.5pt}
...
?>
	...
	<form name="frmimpresion" >
		...
		<tr>
                    ...
                    <td colspan="2" class="Estilo6"><?php echo$row['IdNumeroExp'];?></td>
                </tr>
                <tr>    
                ...
                <tr>
                    <td colspan='6'>
                        <table width="100%"  align="center" border="0" cellspacing="0" >
                            <tr>
                                <td align="center" class="Estilo5"><strong>Prueba Realizada</strong> </td>
                            ...
                            <tr>
                                <td align="center" class="Estilo6"><?php echo htmlentities($fila['NombreExamen'])?></td>
                                <td align="center" class="Estilo6"><?php echo htmlentities($resultado)?></td>
                       <?php if (!empty($fila['Unidades'])){ ?>  
                                <td align="center" class="Estilo6"><?php echo htmlentities($fila['Unidades']) ?></td>
                       <?php }else{?>  
                                <td  align="center" class="Estilo6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
                       <?php }    
                             if ((!empty($fila['RangoInicio'])) && (!empty($fila['RangoFin']))){ ?>        
                                <td align="center" class="Estilo6"><?php echo $fila['RangoInicio']." - ".$fila['RangoFin']?></td>
                        <?php }else{ ?>  
                                <td  align="center" class="Estilo6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
                        <?php }
                            if (!empty($lectura)){ ?>        
                                <td align="justify" class="Estilo6"><?php echo htmlentities($lectura)?></td>
                       <?php }else{?>  
                                <td  align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
                       <?php }  
                             if (!empty($lectura)){    ?> 
                                <td align="justify" class="Estilo6"><?php echo htmlentities($interpretacion)?></td>
                       <?php }else{?>  
                                <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
                       <?php }  
                             if (!empty($observacion)){ ?>    
                                <td align="justify" class="Estilo6"><?php echo htmlentities($observacion)?></td>
                       <?php }else{?>
                                <td  align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
                       <?php } ?> 
                            </tr> 
