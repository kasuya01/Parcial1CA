...
?>
	...
	<tr>
		<td class="Estilo5" colspan="1" style="font:bold"><strong>NEC</strong></td>
                <td class="Estilo6" colspan="5"><?php echo $row_generales['IdNumeroExp']?></td>
        </tr>
	<tr>	
	...
	<tr>
		<td class="Estilo5" colspan="1" style="font:bold"><strong>Examen Realizado:</strong></td>
	  	<td class="Estilo6" colspan="4" ><?php echo htmlentities($row_area['NombreExamen']);?></td>
	</tr>				 
	...
	<tr> 
		...
		<table width="75%" border="0" align="left" cellspacing="0" >
                    <tr>
                        <td class="Estilo5" colspan="1" style="font:bold"><strong>Resultado:</strong></td>
                        <td class="Estilo6" colspan="5" ><?php echo "Positivo"?></td>
                    </tr>
                    <tr>
                            <td class="Estilo5" colspan="1" style="font:bold"><strong>Organismo:</strong></td>
			...
			<tr>
                            <td colspan='6'>
                                <table width="100%" border="0" align="left" cellspacing="0" >
                                    ...
                                    {?>
                                    <tr>
                                         <td class="Estilo6" colspan="1"><?php echo $row['Antibiotico']?></td>
                                         <td class="Estilo6" colspan="2"><?php echo htmlentities($vector_valores[$pos])?>
