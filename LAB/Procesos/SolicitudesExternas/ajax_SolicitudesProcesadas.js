...
function GuardarResultados()
{
   ...
   codigo=6;
   IdEstabExt=document.frmnuevo.txtIdEstabExt.value;
   opcion=3;
   idexpediente="";
   idarea="";
   pag="";
   ...
   "&idrecepcion="+idrecepcion+"&resultado="+encodeURIComponent(resultado)+
  // "&lectura="+encodeURIComponent(lectura)+
  // "&interpretacion="+encodeURIComponent(interpretacion)+
...
function MostrarAntibioticos()
{
 // if(validartarjeta()){
  opcion=1;
   ...
   ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
  //alert(IdEstabExt);
   ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idtarjeta="+idtarjeta+"&IdEstabExt="+IdEstabExt);
		...
		//nombrearea="";
  		...
  		valores_antibioticos="";
  		 ...
  		 if (document.getElementById('oculto').value > 0)
			...
			"&valores_antibioticos="+encodeURIComponent(valores_antibioticos)+"&codigos_antibioticos="+codigos_antibioticos+
			"&idtarjeta="+idtarjeta+"&idbacteria="+idbacteria+"&cantidad="+encodeURIComponent(cantidad)+"&estab="+estab+
                        "&IdEstabExt="+IdEstabExt);
			ajax.onreadystatechange=function() 
			{
				if (ajax.readyState==4) 
...
opcion=5;
   ...
   ajax.open("POST", "ctrDatosResultadosExamen_PC.php",true);
   ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
   ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idtarjeta="+idtarjeta+"&tiporespuesta="+tiporespuesta+"&idarea="+idarea+
   "&idsolicitud="+idsolicitud+"&idempleado="+idempleado+"&observacion="+encodeURIComponent(observacion)+
   "&resultado="+resultado+"&estab="+estab+"&IdEstabExt="+IdEstabExt);
   ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
...
//function ImprimirPlantillaA(idsolicitud,idexamen,detallesolicitud,resultado,lectura,interpretacion,observacion,responsable,sexo,edad,IdEstabExt){
function ImprimirPlantillaA(idsolicitud,idexamen,detallesolicitud,resultado,observacion,responsable,sexo,edad,IdEstabExt){
//alert (IdEstabExt+"sexo="+sexo+"edad="+edad);
 ventana_secundaria = window.open("ImprimirPlantillaA.php?var1="+idsolicitud+
	"&var2="+idexamen+"&var3="+detallesolicitud+"&var4="+encodeURIComponent(resultado)+
        //"&var5="+encodeURIComponent(lectura)+
        //"&var6="+encodeURIComponent(interpretacion)+
        "&var7="+encodeURIComponent(observacion)+"&var8="+responsable+"&var9="+sexo+
        "&var10="+edad+"&var11="+IdEstabExt,"ImprimirA","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
}
...
//alert (establecimiento);
 ventana_secundaria = window.open("ImprimirPlantillaA1.php?var1="+idsolicitud+
	...
	"&var4="+encodeURIComponent(valores_resultados)+"&var5="+codigos_resultados+
	"&var6="+encodeURIComponent(valores_lecturas)+"&var7="+encodeURIComponent(valores_inter)+"&var8="+encodeURIComponent(valores_obser)+
	"&var9="+codigos_examenes+"&var10="+establecimiento+"&var11="+sexo+"&var12="+idedad,"ImprimirA1","width=950,ccc=700,menubar=no,scrollbars=yes,location=no");
}
...
function ImprimirPlantillaB(idsolicitud,idexamen,responsable,procedencia,origen,observacion,valores_subelementos,codigos_subelementos,valores_elementos,codigos_elementos,controles,controles_ele,nombrearea,establecimiento,responsable,sexo,idedad){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaB.php?var1="+idsolicitud+
	...
	"&var5="+escape(origen)+"&var6="+encodeURIComponent(observacion)+
	"&var7="+encodeURIComponent(valores_subelementos)+
	"&var8="+codigos_subelementos+"&var9="+encodeURIComponent(valores_elementos)+
	"&var10="+codigos_elementos+"&var11="+encodeURIComponent(controles)+
	"&var12="+encodeURIComponent(controles_ele)+
	"&var13="+escape(nombrearea)+"&var14="+escape(establecimiento)+
	"&var15="+responsable+"&var16="+sexo+"&var17="+idedad,"ImprimirB","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function ImprimirPlantillaC(idsolicitud,idexamen,resultado,responsable,procedencia,origen,observacion,valores_antibioticos,codigos_antibioticos,idbacteria,cantidad,idtarjeta,nombrearea,estab){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaC.php?var1="+idsolicitud+
				 ...
				 +"&var11="+encodeURIComponent(cantidad)+"&var12="+idtarjeta+
				 "&var13="+escape(nombrearea)+"&var14="+escape(estab)+"&var15="+IdEstabExt,"ImprimirC","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function ImprimirPlantillaCN(idsolicitud,idexamen,detallesolicitud,idarea,resultado,lectura,interpretacion,observacion,responsable,procedencia,origen){
 ...
 ventana_secundaria = window.open("ImprimirPlantillaCN.php?var1="+idsolicitud+
		 ...
		 "&var5="+resultado+"&var6="+encodeURIComponent(lectura)+"&var7="+encodeURIComponent(interpretacion)+
		 "&var8="+encodeURIComponent(observacion)+"&var9="+responsable+"&var10="+procedencia+
		 "&var11="+origen+"&var12="+IdEstabExt,"ImprimirCN","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
function ImprimirPlantillaE(idsolicitud,idexamen,responsable,procedencia,origen,cometarios,valores,codigo,observacion,estab,sexo,idedad){
	...
	"&var8="+codigo+"&var9="+encodeURIComponent(observacion)+"&var10="+escape(estab)+
        "&var11="+sexo+"&var12="+idedad,"ImprimirE","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
}
...
//function MostrarResultadoExamen(idsolicitud,iddetalle,idarea,idexamen,resultado,lectura,interpretacion,observacion,responsable,nombrearea,procedencia,origen,impresion,establecimiento,codigo,fechanac,sexo,IdEstabExt)
function MostrarResultadoExamen(idsolicitud,iddetalle,idarea,idexamen,resultado,observacion,responsable,nombrearea,procedencia,origen,impresion,establecimiento,codigo,fechanac,sexo,IdEstabExt)
{
   ajax=objetoAjax();
   opcion=4;
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	  //enviando los valores
	/*ajax.send("opcion="+opcion+"&idsolicitud="+idsolicitud+"&iddetalle="+iddetalle+"&idarea="+area+"&idexamen="+idexamen+
	"&resultado="+encodeURIComponent(resultado)+"&lectura="+encodeURIComponent(lectura)+
        "&interpretacion="+encodeURIComponent(interpretacion)+"&observacion="+encodeURIComponent(observacion)+
	"&responsable="+responsable+"&nombrearea="+escape(nombrearea)+"&procedencia="+escape(procedencia)+
	"&origen="+escape(origen)+"&impresion="+impresion+"&establecimiento="+establecimiento+"&codigo="+codigo+
        "&fechanac="+fechanac+"&sexo="+sexo+"&IdEstabExt="+IdEstabExt);*/
	ajax.send("opcion="+opcion+"&idsolicitud="+idsolicitud+"&iddetalle="+iddetalle+"&idarea="+area+"&idexamen="+idexamen+
	"&resultado="+encodeURIComponent(resultado)+"&observacion="+encodeURIComponent(observacion)+
	"&responsable="+responsable+"&nombrearea="+escape(nombrearea)+"&procedencia="+escape(procedencia)+
	"&origen="+escape(origen)+"&impresion="+impresion+"&establecimiento="+establecimiento+"&codigo="+codigo+
        "&fechanac="+fechanac+"&sexo="+sexo+"&IdEstabExt="+IdEstabExt);
	ajax.onreadystatechange=function() 
...
function MostrarVistaPreviaPlantillaB()
{
  ...
  if (ValidarCamposPlantillaB())
  {
	...
	//alert (estab);
		...
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
	          "&iddetalle="+iddetalle+"&observacion="+encodeURIComponent(observacion)+"&idempleado="+idempleado+
			  "&procedencia="+escape(procedencia)+"&origen="+escape(origen)+
			  "&valores_subelementos="+encodeURIComponent(valores_subelementos)+"&codigos_subelementos="+codigos_subelementos+
			  "&valores_elementos="+encodeURIComponent(valores_elementos)+"&codigos_elementos="+codigos_elementos+
			  "&controles="+encodeURIComponent(controles)+"&controles_ele="+encodeURIComponent(controles_ele)+
...
function GuardarResultadosPlantillaC()
{
   ...
   "&valores_antibioticos="+encodeURIComponent(valores_antibioticos)+"&codigos_antibioticos="+codigos_antibioticos+
   "&idtarjeta="+idtarjeta+"&tiporespuesta="+tiporespuesta+"&idarea="+idarea+"&nombrearea="+escape(nombrearea)+
   "&resultado="+resultado+"&idbacteria="+idbacteria+"&cantidad="+encodeURIComponent(cantidad));
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
  ...
  //  if(ValidarCamposPlantillaB())
 	//{
		...
		ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		  //enviando los valores
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
                          "&iddetalle="+iddetalle+"&observacion="+escape(observacion)+"&idempleado="+idempleado+"&procedencia="+procedencia+
			  "&origen="+origen+"&valores_subelementos="+encodeURIComponent(valores_subelementos)+
			  "&codigos_subelementos="+codigos_subelementos+"&valores_elementos="+encodeURIComponent(valores_elementos)+
			  "&codigos_elementos="+codigos_elementos+"&controles="+encodeURIComponent(controles)+
			  "&controles_ele="+encodeURIComponent(controles_ele)+"&tab="+tab);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
				{	 if (ajax.status == 200)
		...
		switch (plantilla)
		 {  case "A":
		  if (idarea=="QUI"){
                            ...
                            "&var2="+escape(examen)+"&var3="+idexamen+"&var4="+idarea+"&var5="+detallesolicitud+"&var6="+idsolicitud+
                            "&var7="+escape(paciente)+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+procedencia+"&var11="+origen+
                            "&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                            "&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
			 }
		  else{
                            ventana_secundaria = window.open("ProcDatosResultadosExamen_PA.php?var1="+idexpediente+
                            "&var2="+escape(examen)+"&var3="+idexamen+"&var4="+idarea+"&var5="+detallesolicitud+"&var6="+idsolicitud+
                            "&var7="+paciente+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+"&var10="+escape(procedencia)+"&var11="+escape(origen)+
                            "&var12="+impresion+"&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                            "&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,ccc=700,menubar=no,scrollbars=yes,location=no") ;
				 }
		  break;
		  ...
		  ventana_dos = window.open("ProcDatosResultadosExamen_PB.php?var1="+idexpediente+
					...
					"&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                                        "&var13="+estab+"&var14="+FechaNac+
                                        "&var15="+Sexo+"&var16="+IdEstandar+"&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  break;
		  case "C":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PC.php?var1="+idexpediente+
                            ...
                            "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                            "&var13="+estab+"&var16="+IdEstandar+"&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,height=700,menubar=no,scrollbars=yes,location=no") ;
		  break;
		  case "D":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PD.php?var1="+idexpediente+
                            "&var2="+escape(examen)+"&var3="+idexamen+"&var4="+idarea+
                            "&var5="+detallesolicitud+"&var6="+idsolicitud+
                            "&var7="+paciente+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+
                            "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                            "&var13="+estab+"&var14="+IdEstandar+
                            "&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,height=700,menubar=no,scrollbars=yes") ;
		  break;
		 case "E":
                        ventana_dos = window.open("ProcDatosResultadosExamen_PE.php?var1="+idexpediente+
                            ...
                            "&var7="+paciente+"&var8="+idrecepcion+"&var9="+escape(nombrearea)+
                            "&var10="+procedencia+"&var11="+origen+"&var12="+impresion+
                            "&var13="+estab+"&var14="+FechaNac+"&var15="+Sexo+"&var16="+IdEstandar+
                            "&var17="+IdHistorial+"&var18="+IdEstabExt,"Resultados","width=950,height=950,menubar=no,scrollbars=yes") ;
		break;
		}
...
function SolicitudesPorAreaPendientes()
{
	...
	ajax.send("opcion="+opcion+"&idarea="+idarea+"&idexpediente="+idexpediente+
             "&idexamen="+idexamen+"&fecharecep="+fecharecep+"&IdEstab="+IdEstab+"&IdServ="+IdServ+"&IdSubServ="+IdSubServ+
	     "&PNombre="+PNombre+"&SNombre="+SNombre+"&PApellido="+PApellido+"&SApellido="+SApellido+"&TipoSolic="+TipoSolic);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
...
function MostrarVistaPreviaPlantillaA1()
{
  ...
  if (ValidarCamposPlantillaA())
  {
		...
		"&valores_inter="+encodeURIComponent(valores_inter)+
		"&valores_obser="+encodeURIComponent(valores_obser)+
		"&codigos_examenes="+escape(codigos_examenes)+"&estab="+estab+"&fechanac="+fechanac+"&sexo="+sexo);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{	 if (ajax.status == 200)
...
function CargarExamenes(idsolicitud,idarea,fechanac,sexo,idestandar,idhistorial)
{
   	ajax=objetoAjax();
        ...
        //IdHistorial=idhistorial;
 	opcion=1;
	//alert("AJAX "+idhistorial+" - "+idsolicitud+" - "+idarea+" - "+FechaNac+" - "+Sexo+" - "+IdEstandar);	
	ajax.open("POST", "ctrDatosResultadosExamen_PA.php",true);
	  //muy importante este encabezado ya que hacemos uso de un formulario
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	  //enviando los valores
	...
	ajax.send("opcion="+opcion+"&idsolicitud="+idsolicitud+"&idarea="+idarea+"&FechaNac="+FechaNac+
                "&Sexo="+Sexo+"&IdEstandar="+idestandar+"&idhistorial="+idhistorial);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	if (ajax.status == 200)
...
function CargarProcesosExamen(codigoex,fechanac,sexo)
{
	...
	ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&idrecepcion="+idrecepcion+
	          "&iddetalle="+iddetalle+"&observacion="+escape(observacion)+"&idempleado="+idempleado
			  +"&valores="+valores+"&codigos="+codigos+"&comentarios="+escape(comentarios)+"&fechanac="+fechanac+"&sexo="+sexo);
	ajax.onreadystatechange=function() 
	{
		if (ajax.readyState==4) 
		{	 if (ajax.status == 200)
...
function MostrarVistaPreviaPlantillaE()
{
	if (ValidarCamposPlantillaE())
	{
		...
		ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
		  //enviando los valores
		ajax.send("opcion="+opcion+"&idexamen="+idexamen+"&idsolicitud="+idsolicitud+"&observacion="+encodeURIComponent(observacion)+
