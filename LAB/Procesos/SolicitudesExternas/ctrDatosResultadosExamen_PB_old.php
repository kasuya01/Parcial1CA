  ...
  switch ($IdEstandar){
	...
	{  
		...
		{   $imprimir.="<tr>
				...
				$consulta2=$objdatos->LeerSubElementosExamen($row['IdElemento'],$lugar);
		...
		$imprimir.="<tr>
						...
						<td class='StormyWeatherDataTD' width='30%'>
							<input name='txtcontrolele[".$posele."]' type='text' id='txtcontrolele[".$posele."]'>
						</td>	
			...
			$imprimir.="
					<tr><td colspan='2'  class='StormyWeatherDataTD'>*Resultado Tabulador</td><TD colspan='3' class='StormyWeatherDataTD'>
						<select id='cmbTabulador' name='cmbTabulador' size='1'>
							...
							$conResult=$objdatos->LlenarResultados();
	...
	default:
		...
		{  
		   ...
		   $imprimir.= "<tr>
					<td colspan='3' class='StormyWeatherDataTD'>".htmlentities($row['ObservElem'])."</td>
				</tr>
				<tr>
					<td colspan='3' class='StormyWeatherDataTD'>&nbsp;</td></tr>";
			}//if
			else
			{	
			$imprimir.="<tr>
...
//echo $IdEstandar;
		...
		$imprimir="<table width='90%' align='center'class='StormyWeatherFormTABLE' >
				   ...
				   <tr>	
						...
						<td colspan='2' style='font:bold'>".$row_generales['Origen']."</td>
				   </tr>
				   <tr>
						...
						<td colspan='2'>".$row_generales['NombrePaciente']."</td>
				   </tr>
				   <tr>
				   ...
				   <tr>
						...
						<td colspan='4'>".htmlentities($row_empleado['NombreEmpleado'])."</td>
				   </tr>
				   <tr>
	  ...
	  $imprimir.=" <tr><td style='font:bold' >Resultado Tabulador:</td><td colspan='4'>".$row_codigo[0]."</td></tr>
	   ...
	   $imprimir.= "<tr>
		...
		default:
			...
			$imprimir="<br><table width='90%' border='0' align='center' class='StormyWeatherFormTABLE'>
				<tr>
				 	<td align='center' colspan='6' class='CobaltButton'>
				 	<p><strong>RESULTADOS LABORATORIO CL&Iacute;NICO</strong></p>
				...
				<tr>	
					...
					<td colspan='1'>&nbsp;&nbsp;&nbsp;</td>
					<td colspan='1' style='font:bold'><strong>Servicio:</strong></td>
					<td  style='font:bold'colspan='3'>".htmlentities($row_generales['Origen'])."</td>
				</tr>
				<tr>
					 <td colspan='1' style='font:bold'><strong>Examen Realizado:</strong></td>
					 <td colspan='4'style='font:bold'>".htmlentities($row_area['NombreExamen'])."</td>
			...
			{  
				...
				if($row['SubElemento']=="S")
				{   $imprimir.= "<tr class='StormyWeatherFieldCaptionTD'>
				  <td colspan='3' style='font:bold'><strong>".htmlentities($row['Elemento'])."</strong></td>
				 </tr>";
					$consulta2=$objdatos->LeerSubElementosExamen($row['IdElemento'],$lugar);
					...
					while($rowsub = mysql_fetch_array($consulta2))//SUBELEMENTOS
					{
						$imprimir.= "<tr >
						  ...
						  <td width='15%'>".htmlentities($rowsub['Unidad'])."</td>
						 </tr>";
						$pos=$pos + 1;
					}
					$imprimir.= "<tr>
			...
			$imprimir.="<tr>
				<td colspan='3'>
				<input type='button' id='btnGuardar' value='Guardar Resultados' onclick='GuardarResultadosPlantillaB()'>
				<input type='button' name='Imprimir'  id='Imprimir' value='Imprimir' Onclick='ImprimirPlantillaB(".$idsolicitud.",\"".$idexamen."\",\"".$idempleado."\",\"".$row_generales['Procedencia']."\",\"".$row_generales['Origen']."\",\"".htmlentities($observacion)."\",\"".htmlentities($valores_subelementos)."\",\"".$codigos_subelementos."\",\"".htmlentities($valores_elementos)."\",\"".$codigos_elementos."\",\"".htmlentities($controles)."\",\"".htmlentities($controles_ele)."\",\"".htmlentities($row_area['NombreArea'])."\",\"". $establecimiento."\",\"".htmlentities($row_empleado['NombreEmpleado'])."\") ;'>
				<input type='button' id='btnSalir' value='Cerrar' onclick='Cerrar()'>
				</td>
				</tr>
	           </table>";
