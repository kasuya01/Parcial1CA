...
switch ($opcion) 
{
  ...
  $query = "SELECT IdPlantilla,sec_detallesolicitudestudios.IdDetalleSolicitud, sec_solicitudestudios.IdSolicitudEstudio,NumeroMuestra, 	
						...
						mnt_establecimiento.Nombre,IF(sec_solicitudestudios.IdTipoSolicitud='S','URGENTE','NORMAL') AS prioridad,FechaNacimiento,Sexo   
   ...
   //Cambia estado del detalle de la solicitud
	...
	case 4: //MOSTRAR PREVIAMENTE LOS RESULTADOS 
		...
		$Imprimir="<table width='90%' align='center' class='StormyWeatherFormTABLE'>
			...
			$consulta2=$objdatos->MostrarDatosFijosPlantillaA($idexamen,$lugar,$idsolicitud,$sexo,$idedad);
			...
			<tr>
				<td colspan='7' align='center' >
					...
					<input type='button' name='Imprimir'  id='Imprimir' value='Imprimir' Onclick='ImprimirPlantillaA(".$idsolicitud.",\"".$idexamen."\",\"".$resultado."\", \"".htmlentities($lectura)."\",\"".htmlentities($interpretacion)."\",\"".htmlentities($observacion)."\",\"".$responsable."\") ;'>
