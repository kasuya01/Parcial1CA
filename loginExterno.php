<html>
<head>
<title>Identificaci&oacute;n de Usuarios</title><script language='javascript'>
</script>
</style>
...
<table align="center" width="100%" border="0" class="MailboxFormTABLE">
  ...
  <tr>
        <td bordercolor="#FFFFFF">
            <table width="44%" border="2" align="center"  class="MailboxFormTABLE" cellpadding="4" cellspacing="4">
                <tr>
                ...
                <tr>
                    ...
                    <td width="60%" class="MailboxDataTD">
                            <select id="cmbEstablecimiento" name="cmbEstablecimiento" size="1">
                                ...
                                <option value="1">U.de S. SAN MIGUELITO</option>
                                <option value="2">U.de S. CONCEPCIÓN </option>
                            </select>
                    </td>
              </tr>
              <tr>
